...
guide](https://github.com/ropensci/onboarding/blob/master/packaging_guide.md)
...
edit the `README.Rmd` source file in `manuscripts` and run `make` to
build the README.
...
3.  Docs should point advanced users to the lower-level API when they
    need special cases.  
